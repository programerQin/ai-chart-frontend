import { getChartByIdUsingGet, updateChartUsingPost } from '@/services/aichart/chartController';
...
const chartDetail: React.FC = () => {
  ...
  return (
    <div className="chartDetail">
      ...
      <Row gutter={24}>
        <Col span={12}>
          <Divider style={{ color: 'black' }}>原始数据</Divider>
          <Card>
            <div style={{ whiteSpace: 'pre-wrap', overflow: 'auto' }}>
              <p style={{ fontWeight: 'lighter', color: 'green', textAlign: 'center' }}>
                {chart?.chartData}
              </p>
            </div>
          </Card>
        ...
        <Col span={12}>
          <Divider style={{ color: 'black' }}>图表信息</Divider>
          ...
          <Divider style={{ color: 'black' }}>分析结论</Divider>
          <Card>
            <div style={{ whiteSpace: 'pre-wrap', overflow: 'auto' }}>
              <p style={{ fontWeight: 'lighter', color: 'red', textAlign: 'left' }}>
                {chart?.genResult}
              </p>

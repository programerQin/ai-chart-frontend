import { checkInUsingPost, getUserByIdUsingGet } from '@/services/aichart/scoreController';
import { uploadUsingPost } from '@/services/aichart/commonController';
import { getLoginUserUsingGet, updateMyUserUsingPost } from '@/services/aichart/userController';
